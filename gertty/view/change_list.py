...
class ChangeRow(urwid.Button):
    ...
    def update(self, change, categories):
        ...
        self.subject.set_text(change._subject)
...
class ChangeListView(urwid.WidgetWrap):
    ...
    def refresh(self, event=None):
        ...
        with self.app.db.getSession() as session:
            ...
            if self.reverse:
                ...
                change_list = lst
            change_list = self._threadChanges(session, change_list)
    ...
    def _threadChanges(self, session, changes):
        ret = []
        stack = ThreadStack()
        children = {}
        commits = {}
        ...
        for change in changes:
            ...
            if parent:
                if parent.revisions[-1].commit != revision.parent:
                    ...
                    # the list.  TODO: use color to indicate it is
