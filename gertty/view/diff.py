    ...
    def handleUndisplayedComments(self, comment_lists):
        ...
        while comment_lists:
            ...
            try:
                ...
                # FIXME(lifeless): When showing for instance patchset 15->16
                # and there are comments on p16 on file foo, but no difference
                # in file foo from p15 to p16 then foo won't be in oldnew.  The
                # right conceptual fix is probably to add foo with content
